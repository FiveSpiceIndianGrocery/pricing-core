...
const pIdentity = calculatePrice(cost, marginBps, "margin", "identity");
console.log("identity:", pIdentity.toString(), "cents = $", (Number(pIdentity) / 100).toFixed(2));

// Using ceilStep5 (nickel)
const pNickel = calculatePrice(cost, marginBps, "margin", "ceilStep5");
console.log("ceilStep5:", pNickel.toString(), "cents = $", (Number(pNickel) / 100).toFixed(2));

// .99 ending
const pCharm = calculatePrice(cost, marginBps, "margin", "charm99");
...
const pCustom = calculatePrice(cost, marginBps, "margin", lastDigit9);
